...
try:
    ...
    try:
        ...
        wind_direction_avg = wind_dir_device.get_calibrated_direction(wind_direction_adc)
        data_collected['wind_dir_avg'] = wind_direction_avg
        if SCREEN_DISPLAY:
            print(sensor_name.upper() + ": " + msg.rstrip())
        if SAVE_TO_CSV:
            csv_fid.write("{0}{1}".format(DELIMITER, wind_direction_avg))
    finally:
        pass
